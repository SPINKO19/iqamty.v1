...
| Core Navigation Fixes | Core | - | [ ] |

## How to use this file:
1.  Add your name to the **Owner** column when you start a task.
2.  Update the **Status** to `[/]` (in progress) or `[x]` (done).
3.  Add new tasks at the bottom.
