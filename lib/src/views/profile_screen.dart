...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                // Action Items
                _buildActionItem(context, Icons.person_outline_rounded, 'Informations Personnelles', 'Gérer vos données', () {}),
                const SizedBox(height: 12),
                _buildActionItem(context, Icons.notifications_none_rounded, 'Notifications', 'Préférences d\'alerte', () {}),
                const SizedBox(height: 12),
                _buildActionItem(context, Icons.security_rounded, 'Sécurité', 'Mot de passe & Authentification', () {}),
                const SizedBox(height: 12),
                _buildActionItem(
                  context, 
                    ...
                    children: [
                      Align(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              _isShowingResidence ? 'بطاقة الإقامة' : 'بطاقة الطالب',
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Text(
            student?.residence?.toUpperCase() ?? "RÉSIDENCE NON ASSIGNÉE",
            style: GoogleFonts.inter(
              color: AppColors.primary,
              fontSize: 11,
  ...
  Widget _buildOfficialCard(BuildContext context, dynamic student, String name, String dob, bool isResidence) {
    ...
    return Container(
      ...
      height: 285, // Increased by 5px to fix the 2.0px overflow exactly
      ...
      child: Stack(
        children: [
          // Algerian Card Patterns (Subtle Waves)
          // Modern background pattern (Top Green Accent)
          Positioned(
            top: 0,
            left: 0,
            right: 0,
                ...
                Column(
                  children: [
                    Row(
                      ...
                      children: [
                        if (isResidence) 
                          Image.asset('assets/images/dou_logo.png', height: 32, errorBuilder: (c, e, s) => Icon(Icons.shield_outlined, color: mainGreen, size: 32))
                        else
                          Icon(Icons.school, color: mainGreen, size: 32),
          ...
          // Removing Yellow Sidebar (Requested)
        ],
      ),
    );
  }
  ...
  void _showLogoutConfirmation(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Voulez-vous vraiment vous déconnecter de votre compte ?', style: GoogleFonts.inter()),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
          ...
          ElevatedButton(
            ...
            child: Text('Déconnecter', style: GoogleFonts.inter(fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
