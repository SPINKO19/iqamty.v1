...
class HomeScreen extends StatelessWidget {
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                _buildSectionHeader(context, 'Annonces Récentes', onPressed: () {}),
                  ...
                  child: StreamBuilder<List<Announcement>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (announcements.isEmpty) {
                        return _buildEmptyState(context, Icons.campaign_rounded, "Aucune annonce");
                      }
                ...
                _buildSectionHeader(context, 'Au Menu Aujourd\'hui'),
                const SizedBox(height: 20),
  ...
  Widget _buildSectionHeader(BuildContext context, String title, {VoidCallback? onPressed}) {
    return Row(
