...
class AdminAnnouncementsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          _buildActionCard(
            ...
            'Communiquez avec tous les résidents instantanément.',
          ...
          _buildModernAnnouncementCard(
            context,
            'Coupure d\'électricité planifiée',
            'Une maintenance électrique aura lieu demain de 14h à 16h au Bloc J.',
            'Hier, 14:30',
            true,
          ),
          const SizedBox(height: 16),
          _buildModernAnnouncementCard(
            ...
            'Le menu de ce samedi sera composé de spécialités traditionnelles.',
            'Lundi, 10:00',
            false,
          ),
          const SizedBox(height: 16),
          _buildModernAnnouncementCard(
            context,
            'Rappel: Paiement de loyer',
            'N\'oubliez pas de régulariser votre situation avant le 5 du mois.',
            '01 Mars, 09:00',
            false,
          ),
        ],
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {},
        label: Text('Diffuser', style: GoogleFonts.inter(fontWeight: FontWeight.bold)),
  ...
  Widget _buildModernAnnouncementCard(BuildContext context, String title, String body, String time, bool isUrgent) {
    return Container(
